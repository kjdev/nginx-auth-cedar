...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_neq.cedar;
--- config
    location /test.html {
        auth_cedar on;
...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_lt.cedar;
--- config
    location /test.html {
        auth_cedar on;
    }
...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_lt_false.cedar;
--- config
    location /test.html {
        auth_cedar on;
    }
...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_le.cedar;
--- config
    location /test.html {
        auth_cedar on;
    }
...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_gt.cedar;
--- config
    location /test.html {
        auth_cedar on;
    }
...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_ge.cedar;
--- config
    location /test.html {
        auth_cedar on;
    }
...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_and_or.cedar;
--- config
    location /test.html {
        auth_cedar on;
        auth_cedar_principal_attr role $http_x_role;
...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_not.cedar;
--- config
    location /test.html {
        auth_cedar on;
        auth_cedar_principal_attr role $http_x_role;
...
--- http_config
    auth_cedar_policy_file def $TEST_NGINX_CONF_DIR/policies/op_arith.cedar;
--- config
    location /test.html {
        auth_cedar on;
    }
